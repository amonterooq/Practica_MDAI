...
public class PrendaCalzado extends Prenda{
    ...
    public PrendaCalzado(String nombre, String color, String marca, Usuario usuario, String talla, String urlImagen, List<Conjunto> conjuntos, CategoriaCalzado categoria) {
